...
namespace RecordingApi.Controllers
{
    ...
    public class RecordingsController : ControllerBase
    {
        ...
        {
            var response = await _client.GetCallRecording().PauseRecordingAsync(recordingId);
        ...
        {
            var response = await _client.GetCallRecording().ResumeRecordingAsync(recordingId);
        ...
        {
            var response = await _client.GetCallRecording().GetRecordingStateAsync(recordingId);
